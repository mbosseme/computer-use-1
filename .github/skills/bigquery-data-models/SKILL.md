...
| SASF DHC Join | `matthew-bossemeyer.cdx_sample_size.sa_sf_dhc_join` | Facility/IDN enrichment, hospital metadata (beds, type, geography; filter `dhc_firm_type='Hospital'` for acute care) |
